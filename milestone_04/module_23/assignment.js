...
let add1 = { street: 10, society: "Earth Perfect" };
let add2 = { street: 10 };
// let add3 = { house: "15A", society: "Earth Perfect" };
// let add4 = { street: 11, society: "Only Perfect" };
// let add5 = { street: 12 };
// let add6 = {};
...
// console.log(findAddress(add5));
// console.log(findAddress(add6));
// ------------------------------------------
